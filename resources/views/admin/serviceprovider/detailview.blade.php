...
<div class="card">
             ...
             <div class="card-body">
                      ...
                      <div class="form-group row">
                        <label for="subcategory" class="col-sm-12 col-form-label">Sub Category</label>
                        <div class="col-sm-12">
                      ...
                      <div class="form-group row">
                        <label for="workexperience" class="col-sm-12 col-form-label"> Brief Of Your Experience</label>
                        <div class="col-sm-12">
