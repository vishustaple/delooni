<div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#profile" data-toggle="tab">Create Staff Profile</a></li>
                  <li class="nav-item"><a class="nav-link" href="permissions" data-toggle="tab">Manage Staff</a></li>
